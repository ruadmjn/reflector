...
public class BurpExtender implements IBurpExtender, IScannerCheck, ITab
{
    ...
    private burp.CheckReflection checkReflection;
    ...
    public void registerExtenderCallbacks(final IBurpExtenderCallbacks callbacks)
    {
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                settings = new burp.Settings(callbacks);
                panel = new JPanel();
                ...
                model = new burp.BurpTableModel(settings);
    ...
    private void initListener(){
        ...
        addButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ((burp.BurpTableModel)model).addRow(rowData);
            }
        });
        ...
        deleteButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(i >= 0){
                    ((burp.BurpTableModel)model).removeRow(i);
                }
            }
        });
    ...
    public List<IScanIssue> doPassiveScan(IHttpRequestResponse baseRequestResponse) {
        ...
        if ( isContentTypeAllowed )
        {
            ...
            this.checkReflection = new burp.CheckReflection(settings, helpers, baseRequestResponse, callbacks);
            ...
            if (!reflections.isEmpty())
            {
                ...
                List<burp.Pair> pairs = new ArrayList<>();
                for(Map param: reflections) {
                    ...
                    for (Object pair : (ArrayList)param.get(MATCHES)) {
                        pairs.add(new burp.Pair((int[]) pair));
                    }
                }
                String START = ":<br><ul>";
                String END = "</ul>";
                ...
                Collections.sort(pairs, new Comparator<burp.Pair>() {
                    @Override
                    public int compare(burp.Pair o1, burp.Pair o2) {
